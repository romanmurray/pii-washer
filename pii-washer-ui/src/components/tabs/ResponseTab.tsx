...
export function ResponseTab() {
  ...
  // updated_at changes on every server-side mutation — a reliable signal that the
  // session's text may have changed, with no false negatives from edits that keep
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <WorkflowNav back={{ label: 'Review', tab: 'review' }} />
    </div>
  );
}
